...
<asp:Content ContentPlaceHolderId="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <link rel="stylesheet" href="//ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/themes/smoothness/jquery-ui.css?_1448236831507">
...
;(function() {
var text_scripts_mainhtml, jquery, vendor_SPWidgets_src_spapi_getSiteUrl, vendor_SPWidgets_src_sputils_cache, vendor_SPWidgets_src_jsutils_objectExtend, vendor_SPWidgets_src_jsutils_dataStore, vendor_SPWidgets_src_jsutils_Compose, vendor_SPWidgets_src_sputils_getNodesFromXml, vendor_SPWidgets_src_models_ListModel, vendor_SPWidgets_src_sputils_doesMsgHaveError, vendor_SPWidgets_src_spapi_getList, vendor_SPWidgets_src_models_ListItemModel, vendor_SPWidgets_src_spapi_getListItems, vendor_SPWidgets_src_models_ListColumnModel, vendor_SPWidgets_src_spapi_getListColumns, vendor_SPWidgets_src_spapi_getListFormCollection, vendor_SPWidgets_src_sputils_getMsgError, vendor_SPWidgets_src_spapi_updateListItems, vendor_SPWidgets_src_sputils_fillTemplate, vendor_SPWidgets_src_uiutils_makeSameHeight, vendor_SPWidgets_src_uiutils_addHoverEffect, text_vendor_SPWidgets_src_boardWidget_boardhtml, less_vendor_SPWidgets_src_boardWidget_board, vendor_SPWidgets_src_boardWidget_board, vendor_SPWidgets_src_spapi_getSiteListCollection, less_styles_common, jquery_ui, scripts_main;
text_scripts_mainhtml = '<div class="light-board"> <div class="light-board-menu"> <div class="light-board-menu-lists"> <select> <option value="">loading...</option> </select> </div> <div class="light-board-menu-columns"> <select> <option value="">Pick List First</option> </select> </div> </div> <div class="light-board-kanban"> <p class="light-board-msg">This simple web app is meant to show how easy it is to install MyBoard (<a href="https://paultavares.wordpress.com/my-things/myboard-a-sharepoint-kanban-task-management-system/">link</a>). If you have gotten this far: you have already successfully installed this app, and that is all it takes to also install MyBoard.</p> <p class="light-board-msg">To see a board here, select a List from the drop-down above and then a Column. Note that the board that will be displayed is not identical to the one used by MyBoard. MyBoard provides a much richer interface along with many other features.</p> <p class="light-board-msg">Hope to have you as a supporter.</p> </div> <div class="light-board-footer"> <span>LightBoard | 1448232509689 - 2015-11-22 | &copy; 2015 <a href="https://paultavares.wordpress.com/about/">Paul Tavares</a> | <a href="https://paultavares.wordpress.com/my-things/myboard-a-sharepoint-kanban-task-management-system/">Full Feature MyBoard</a> </span></div> </div> ';
/*!
...
vendor_SPWidgets_src_spapi_getSiteUrl = function ($) {
...
vendor_SPWidgets_src_sputils_cache = function () {
  /**
...
vendor_SPWidgets_src_jsutils_objectExtend = function () {
  /**
...
vendor_SPWidgets_src_jsutils_dataStore = function () {
...
vendor_SPWidgets_src_jsutils_Compose = function (objectExtend, dataStore) {
  /**
  ...
  return Compose;
}(vendor_SPWidgets_src_jsutils_objectExtend, vendor_SPWidgets_src_jsutils_dataStore);
vendor_SPWidgets_src_sputils_getNodesFromXml = function ($) {
  /**
...
vendor_SPWidgets_src_models_ListModel = function (Compose, objectExtend, dataStore, getNodesFromXml) {
  ...
  return ListModel;
}(vendor_SPWidgets_src_jsutils_Compose, vendor_SPWidgets_src_jsutils_objectExtend, vendor_SPWidgets_src_jsutils_dataStore, vendor_SPWidgets_src_sputils_getNodesFromXml);
vendor_SPWidgets_src_sputils_doesMsgHaveError = function ($) {
  /**
...
vendor_SPWidgets_src_spapi_getList = function ($, cache, getSiteUrl, ListModel, doesMsgHaveError) {
  var
    /**
  ...
  return getList;
}(jquery, vendor_SPWidgets_src_sputils_cache, vendor_SPWidgets_src_spapi_getSiteUrl, vendor_SPWidgets_src_models_ListModel, vendor_SPWidgets_src_sputils_doesMsgHaveError);
vendor_SPWidgets_src_models_ListItemModel = function (Compose, objectExtend, dataStore) {
...
}(vendor_SPWidgets_src_jsutils_Compose, vendor_SPWidgets_src_jsutils_objectExtend, vendor_SPWidgets_src_jsutils_dataStore);
vendor_SPWidgets_src_spapi_getListItems = function ($, cache, getSiteUrl, getNodesFromXml, doesMsgHaveError, ListItemModel) {
  /**
  ...
  //end: getListItems()
  return getListItems;
}(jquery, vendor_SPWidgets_src_sputils_cache, vendor_SPWidgets_src_spapi_getSiteUrl, vendor_SPWidgets_src_sputils_getNodesFromXml, vendor_SPWidgets_src_sputils_doesMsgHaveError, vendor_SPWidgets_src_models_ListItemModel);
vendor_SPWidgets_src_models_ListColumnModel = function ($, Compose, objectExtend, dataStore, getNodesFromXml, getListItems) {
  var instData = dataStore.stash,
    /**
     * list Column Model.
     *
...
}(jquery, vendor_SPWidgets_src_jsutils_Compose, vendor_SPWidgets_src_jsutils_objectExtend, vendor_SPWidgets_src_jsutils_dataStore, vendor_SPWidgets_src_sputils_getNodesFromXml, vendor_SPWidgets_src_spapi_getListItems);
vendor_SPWidgets_src_spapi_getListColumns = function ($, getList, cache, getNodesFromXml, ListColumnModel, dataStore) {
  var instData = dataStore.stash,
    /**
...
}(jquery, vendor_SPWidgets_src_spapi_getList, vendor_SPWidgets_src_sputils_cache, vendor_SPWidgets_src_sputils_getNodesFromXml, vendor_SPWidgets_src_models_ListColumnModel, vendor_SPWidgets_src_jsutils_dataStore);
vendor_SPWidgets_src_spapi_getListFormCollection = function ($, cache, getSiteUrl, doesMsgHaveError) {
  /**
...
}(jquery, vendor_SPWidgets_src_sputils_cache, vendor_SPWidgets_src_spapi_getSiteUrl, vendor_SPWidgets_src_sputils_doesMsgHaveError);
vendor_SPWidgets_src_sputils_getMsgError = function ($) {
  /**
...
vendor_SPWidgets_src_spapi_updateListItems = function ($, getSiteUrl, doesMsgHaveError, getMsgError) {
  var
    /**
...
}(jquery, vendor_SPWidgets_src_spapi_getSiteUrl, vendor_SPWidgets_src_sputils_doesMsgHaveError, vendor_SPWidgets_src_sputils_getMsgError);
vendor_SPWidgets_src_sputils_fillTemplate = function ($) {
  /**
...
vendor_SPWidgets_src_uiutils_makeSameHeight = function ($) {
  /**
...
vendor_SPWidgets_src_uiutils_addHoverEffect = function ($) {
  /**
...
.fail(function (jqXHR) {
  ...
  return showBoard;
}(jquery, vendor_SPWidgets_src_spapi_getSiteUrl, vendor_SPWidgets_src_spapi_getListColumns, vendor_SPWidgets_src_spapi_getListFormCollection, vendor_SPWidgets_src_spapi_getListItems, vendor_SPWidgets_src_spapi_updateListItems, vendor_SPWidgets_src_sputils_getNodesFromXml, vendor_SPWidgets_src_sputils_fillTemplate, vendor_SPWidgets_src_uiutils_makeSameHeight, vendor_SPWidgets_src_uiutils_addHoverEffect, vendor_SPWidgets_src_sputils_doesMsgHaveError, vendor_SPWidgets_src_sputils_getMsgError, text_vendor_SPWidgets_src_boardWidget_boardhtml);
vendor_SPWidgets_src_spapi_getSiteListCollection = function ($, cache, getSiteUrl, doesMsgHaveError) {
  /**
...
scripts_main = function (template, $, board, getSiteListCollection, getListColumns) {
  var inst = {},
    /**
     * Apps main module
     * @namespace main
  ...
  return main;
}(text_scripts_mainhtml, jquery, vendor_SPWidgets_src_boardWidget_board, vendor_SPWidgets_src_spapi_getSiteListCollection, vendor_SPWidgets_src_spapi_getListColumns);
(function (c) {
